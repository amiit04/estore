...
class Order(BaseModel):
    ...
    shipping_address = models.ForeignKey(CustomerAddress,on_delete=models.PROTECT, related_name="pship",null=True,blank=True)
    billing_address = models.ForeignKey(CustomerAddress,on_delete=models.PROTECT, related_name="pbill",null=True,blank=True)
