...
class ProfileView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        orders = Order.objects.filter(ordered_by=request.user).order_by('-created_at')
        return render(request, self.template_name, {'user': request.user, 'customer': customer, 'orders': orders,})
